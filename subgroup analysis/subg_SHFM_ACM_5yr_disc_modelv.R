...
# resS_disc_ACM_5yr_30 <- rma.res[[2]]
# res.all <- rma.res[[3]]
# 
...
rma.res <- fn_ma_cstat(dat)
resS_disc_ACM_5yr_Levy2006extval <- rma.res[[2]]
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_5yr_Levy2006PRAISE <- rma.res[[2]]
# res.Levy2006PRAISE <- rma.res[[3]]
# 
resS_disc_ACM_5yr_Levy2006PRAISE <- c(rep("-",5), 2, "-") 
# 
# ################################################################################################
# ###########     GROUP 3    #############
# ################################################################################################
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_5yr_updatemod <- rma.res[[2]]
# res.updatemod <- rma.res[[3]]
# 
resS_disc_ACM_5yr_updatemod <- c(rep("-",5), 1, "-") 
#  
# #################################################################################
# ########################### Forests plot ########################################
# #################################################################################
...
# addpoly(x = resS_disc_ACM_5yr_30$est, ci.lb=resS_disc_ACM_5yr_30$ci.lb, ci.ub=resS_disc_ACM_5yr_30$ci.ub,
...
# addpoly(x =resS_disc_ACM_5yr_Levy2006extval$est, ci.lb=resS_disc_ACM_5yr_Levy2006extval$ci.lb, ci.ub=resS_disc_ACM_5yr_Levy2006extval$ci.ub,
#         row=19.5, mlab=mlabfun("RE Model for Subgroup", res.Levy2006extval))
# addpoly(x =resS_disc_ACM_5yr_Levy2006PRAISE$est, ci.lb=resS_disc_ACM_5yr_Levy2006PRAISE$ci.lb, ci.ub=resS_disc_ACM_5yr_Levy2006PRAISE$ci.ub,
#         row= 10.5, mlab=mlabfun("RE Model for Subgroup", res.Levy2006PRAISE))
# addpoly(x =resS_disc_ACM_5yr_updatemod$est, ci.lb=resS_disc_ACM_5yr_updatemod$ci.lb, ci.ub=resS_disc_ACM_5yr_updatemod$ci.ub,
