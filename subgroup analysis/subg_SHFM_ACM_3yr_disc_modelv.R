...
resS_disc_ACM_3yr_Levy2006extval <- rma.res[[2]]
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_3yr_Levy2006PRAISE <- rma.res[[2]]
# res.Levy2006PRAISE <- rma.res[[3]]

resS_disc_ACM_3yr_Levy2006PRAISE <- c(rep("-",5), 1, "-")
# 
# ################################################################################################
# ###########     GROUP 3    #############
# ################################################################################################
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_3yr_updatemod <- rma.res[[2]]
# res.updatemod <- rma.res[[3]]

resS_disc_ACM_3yr_updatemod <- c(rep("-",5), 0, "-")
