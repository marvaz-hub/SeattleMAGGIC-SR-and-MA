...
# figfile <- "Fig5c_M_3yr_ACMapprox_cal_calibest.jpg"
...
# 
# rma.res <- fn_ma_oe(dat)
# resM_cal_ACM_3yr_oeestfrominterc <- rma.res[[2]]
# res.oeestfrominterc<- rma.res[[3]]

resM_cal_ACM_3yr_oeestfrominterc <- c(rep("-",5), 2, "-") 
...
rma.res <- fn_ma_oe(dat)
resM_cal_ACM_3yr_oerep <- rma.res[[2]]
res.oerep <- rma.res[[3]]
...
# addpoly(x = resM_cal_ACM_3yr_all$est, ci.lb=resM_cal_ACM_3yr_all$ci.lb, ci.ub=resM_cal_ACM_3yr_all$ci.ub,
...
# addpoly(x = resM_cal_ACM_3yr_oeestfrominterc$est, ci.lb=resM_cal_ACM_3yr_oeestfrominterc$ci.lb, ci.ub=resM_cal_ACM_3yr_oeestfrominterc$ci.ub,
#         row=13.5, mlab=mlabfun("RE Model for Subgroup", res.hrob))
# addpoly(x = resM_cal_ACM_3yr_oerep$est, ci.lb=resM_cal_ACM_3yr_oerep$ci.lb, ci.ub=resM_cal_ACM_3yr_oerep$ci.ub,
