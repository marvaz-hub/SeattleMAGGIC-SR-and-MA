...
figfile <- "Fig3a_M_1yr_ACMapprox_cal_rob.jpg"
...
#subgroups Unclear out: count is less than 3

dat <- dat[dat$OS1!="Unclear", ]
table(dat$OS1,useNA = "always") 
...
table(dat1$OS1, useNA = "always") #12
...
rma.res <- fn_ma_oe(dat)
resM_cal_ACM_1yr_hrob <- rma.res[[2]]
res.hrob <- rma.res[[3]]
...
rma.res <- fn_ma_oe(dat)
resM_cal_ACM_1yr_lrob <- rma.res[[2]]
res.lrob <- rma.res[[3]]
...
# 
# rma.res <- fn_ma_oe(dat)
# resM_cal_ACM_1yr_urob <- rma.res[[2]]
# res.urob <- rma.res[[3]]

resM_cal_ACM_1yr_urob <- c(rep("-",5), 1, "-")
...
addpoly(x = resM_cal_ACM_1yr_17$est, ci.lb=resM_cal_ACM_1yr_17$ci.lb, ci.ub=resM_cal_ACM_1yr_17$ci.ub,
...
addpoly(x = resM_cal_ACM_1yr_hrob$est, ci.lb=resM_cal_ACM_1yr_hrob$ci.lb, ci.ub=resM_cal_ACM_1yr_hrob$ci.ub,
        row=10.5, mlab=mlabfun("RE Model for Subgroup", res.hrob))
addpoly(x = resM_cal_ACM_1yr_lrob$est, ci.lb=resM_cal_ACM_1yr_lrob$ci.lb, ci.ub=resM_cal_ACM_1yr_lrob$ci.ub,
        row= 1.5, mlab=mlabfun("RE Model for Subgroup", res.lrob))
# addpoly(x = resM_cal_ACM_1yr_urob$est, ci.lb=resM_cal_ACM_1yr_urob$ci.lb, ci.ub=resM_cal_ACM_1yr_urob$ci.ub,
