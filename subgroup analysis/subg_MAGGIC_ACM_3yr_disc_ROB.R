...
# figfile <- "Fig5a_M_3yr_ACMapprox_disc_rob.jpg"
...
table(dat1$OS1, useNA = "always") #5


dat2 <- dat[which(dat$OS1=="Low"),] 

table(dat2$OS1, useNA = "always") #5


# dat3 <- dat[which(dat$OS1=="Unclear"),] 
# 
# table(dat3$OS1, useNA = "always") #1
...
rma.res <- fn_ma_cstat(dat)
resM_disc_ACM_3yr_hrob <- rma.res[[2]]
res.hrob <- rma.res[[3]]
...
rma.res <- fn_ma_cstat(dat)
resM_disc_ACM_3yr_lrob <- rma.res[[2]]
res.lrob <- rma.res[[3]]
...
# 
# rma.res <- fn_ma_cstat(dat)
# resM_disc_ACM_3yr_urob <- rma.res[[2]]
# res.urob <- rma.res[[3]]
# 
resM_disc_ACM_3yr_urob <- c(rep("-",5), 1, "-")
#  
# #################################################################################
# ########################### Forests plot ########################################
# #################################################################################
...
#        rows=c(33:21,16:10,5:3), # CHANGE studies within groups
#        ylim=(c(-5,nrow(y)+14)),
#        main=titplot
# )
# 
...
# text(-0.3, c(34,17,6), pos=4, c("High RoB Participants",
...
# addpoly(x = resM_disc_ACM_3yr_all$est, ci.lb=resM_disc_ACM_3yr_all$ci.lb, ci.ub=resM_disc_ACM_3yr_all$ci.ub,
...
# addpoly(x = resM_disc_ACM_3yr_hrob$est, ci.lb=resM_disc_ACM_3yr_hrob$ci.lb, ci.ub=resM_disc_ACM_3yr_hrob$ci.ub,
#         row=19.5, mlab=mlabfun("RE Model for Subgroup", res.hrob))
# addpoly(x = resM_disc_ACM_3yr_lrob$est, ci.lb=resM_disc_ACM_3yr_lrob$ci.lb, ci.ub=resM_disc_ACM_3yr_lrob$ci.ub,
#         row= 8.5, mlab=mlabfun("RE Model for Subgroup", res.lrob))
# addpoly(x = resM_disc_ACM_3yr_urob$est, ci.lb=resM_disc_ACM_3yr_urob$ci.lb, ci.ub=resM_disc_ACM_3yr_urob$ci.ub,
