...
figfile <- "Fig2a_M_1yr_ACMapprox_disc_rob.jpg"
...
rma.res <- fn_ma_cstat(dat)
resM_disc_ACM_1yr_hrob <- rma.res[[2]]
res.hrob <- rma.res[[3]]
...
rma.res <- fn_ma_cstat(dat)
resM_disc_ACM_1yr_lrob <- rma.res[[2]]
res.lrob <- rma.res[[3]]
...
rma.res <- fn_ma_cstat(dat)
resM_disc_ACM_1yr_urob <- rma.res[[2]]
res.urob <- rma.res[[3]]
...
addpoly(x = resM_disc_ACM_1yr_hrob$est, ci.lb=resM_disc_ACM_1yr_hrob$ci.lb, ci.ub=resM_disc_ACM_1yr_hrob$ci.ub,
        row=19.5, mlab=mlabfun("RE Model for Subgroup", res.hrob))
addpoly(x = resM_disc_ACM_1yr_lrob$est, ci.lb=resM_disc_ACM_1yr_lrob$ci.lb, ci.ub=resM_disc_ACM_1yr_lrob$ci.ub,
        row= 8.5, mlab=mlabfun("RE Model for Subgroup", res.lrob))
addpoly(x = resM_disc_ACM_1yr_urob$est, ci.lb=resM_disc_ACM_1yr_urob$ci.lb, ci.ub=resM_disc_ACM_1yr_urob$ci.ub,
