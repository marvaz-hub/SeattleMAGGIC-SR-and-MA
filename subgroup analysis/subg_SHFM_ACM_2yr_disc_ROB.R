...
# figfile <- "Fig4e_S_2yr_ACMapprox_disc_rob.jpg"
...
# 
# table(dat2$OS1, useNA = "always") #10
# 
# 
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_2yr_hrob <- rma.res[[2]]
# res.hrob <- rma.res[[3]]

resS_disc_ACM_2yr_hrob <- c(rep("-",5), 2, "-") 
# 
# ################################################################################################
# ###########     GROUP 2 #############
# ################################################################################################
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_2yr_lrob <- rma.res[[2]]
# res.lrob <- rma.res[[3]]

resS_disc_ACM_2yr_lrob <- c(rep("-",5), 2, "-") 
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_2yr_urob <- rma.res[[2]]
# res.urob <- rma.res[[3]]
# 
resS_disc_ACM_2yr_urob <- c(rep("-",5), 1, "-") 
# 
# #################################################################################
# ########################### Forests plot ########################################
# #################################################################################
...
# addpoly(x = resS_disc_ACM_2yr_hrob$est, ci.lb=resS_disc_ACM_2yr_hrob$ci.lb, ci.ub=resS_disc_ACM_2yr_hrob$ci.ub,
#         row=22.5, mlab=mlabfun("RE Model for Subgroup", res.hrob))
# addpoly(x = resS_disc_ACM_2yr_lrob$est, ci.lb=resS_disc_ACM_2yr_lrob$ci.lb, ci.ub=resS_disc_ACM_2yr_lrob$ci.ub,
#         row= 8.5, mlab=mlabfun("RE Model for Subgroup", res.lrob))
# addpoly(x = resS_disc_ACM_2yr_urob$est, ci.lb=resS_disc_ACM_2yr_urob$ci.lb, ci.ub=resS_disc_ACM_2yr_urob$ci.ub,
