...
figfile <- "Fig2f_S_1yr_ACMapprox_disc_HFtype.jpg"
...
rma.res <- fn_ma_cstat(dat)
resS_disc_ACM_1yr_acute <- rma.res[[2]]
res.acute <- rma.res[[3]]
...
rma.res <- fn_ma_cstat(dat)
resS_disc_ACM_1yr_chronic <- rma.res[[2]]
...
rma.res <- fn_ma_cstat(dat)
resS_disc_ACM_1yr_uncmixhf <- rma.res[[2]]
...
forest(y$theta, ci.lb=y$theta.ciub, ci.ub=y$theta.cilb,
       ...
       rows=c(44:39,34:16,11:3), # CHANGE studies within groups
       ylim=(c(-5,nrow(y)+14)),
       main=titplot
)
...
text(-0.3, c(45,35,12), pos=4, c("Acute Heart Failure",
...
addpoly(x =resS_disc_ACM_1yr_acute$est, ci.lb=resS_disc_ACM_1yr_acute$ci.lb, ci.ub=resS_disc_ACM_1yr_acute$ci.ub,
        row=37.5, mlab=mlabfun("RE Model for Subgroup", res.acute))
addpoly(x =resS_disc_ACM_1yr_chronic$est, ci.lb=resS_disc_ACM_1yr_chronic$ci.lb, ci.ub=resS_disc_ACM_1yr_chronic$ci.ub,
        row= 14.5, mlab=mlabfun("RE Model for Subgroup", res.chronic))
addpoly(x =resS_disc_ACM_1yr_uncmixhf$est, ci.lb=resS_disc_ACM_1yr_uncmixhf$ci.lb, ci.ub=resS_disc_ACM_1yr_uncmixhf$ci.ub,
