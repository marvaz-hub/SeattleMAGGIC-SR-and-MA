...
# figfile <- "Fig4h_S_2yr_ACMapprox_disc_modelv.jpg"
...
#  Levy 2006 ext validation         Levy 2006 PRAISE 
#                    3                        1 
#                   Update                     <NA> 
#                     1                        0 
...
# table(dat2$S5, useNA = "always") #1
# 
# 
# dat3 <- dat[which(dat$S5=="Update"),] 
# table(dat3$S5, useNA = "always") #1
...
# resS_disc_ACM_2yr_30 <- rma.res[[2]]
# res.all <- rma.res[[3]]
# 
...
rma.res <- fn_ma_cstat(dat)
resS_disc_ACM_2yr_Levy2006extval <- rma.res[[2]]
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_2yr_Levy2006PRAISE <- rma.res[[2]]
# res.Levy2006PRAISE <- rma.res[[3]]
# 
resS_disc_ACM_2yr_Levy2006PRAISE <- c(rep("-",5), 1, "-") 
# 
# ################################################################################################
# ###########     GROUP 3    #############
# ################################################################################################
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_2yr_updatemod <- rma.res[[2]]
# res.updatemod <- rma.res[[3]]
# 
resS_disc_ACM_2yr_updatemod <- c(rep("-",5), 1, "-") 
#
# #################################################################################
# ########################### Forests plot ########################################
# #################################################################################
...
#        rows=c(40:21,16:12,7:3), # CHANGE studies within groups
#        ylim=(c(-5,nrow(y)+14)),
#        main=titplot
# )
# 
...
# text(-0.3, c(41,17,8), pos=4, c("Levy 2006 ext validation",
#                                  "Levy 2006 PRAISE",
#                                  "Update"))
# 
...
# addpoly(x = resS_disc_ACM_2yr_30$est, ci.lb=resS_disc_ACM_2yr_30$ci.lb, ci.ub=resS_disc_ACM_2yr_30$ci.ub,
...
# addpoly(x =resS_disc_ACM_2yr_Levy2006extval$est, ci.lb=resS_disc_ACM_2yr_Levy2006extval$ci.lb, ci.ub=resS_disc_ACM_2yr_Levy2006extval$ci.ub,
#         row=19.5, mlab=mlabfun("RE Model for Subgroup", res.Levy2006extval))
# addpoly(x =resS_disc_ACM_2yr_Levy2006PRAISE$est, ci.lb=resS_disc_ACM_2yr_Levy2006PRAISE$ci.lb, ci.ub=resS_disc_ACM_2yr_Levy2006PRAISE$ci.ub,
#         row= 10.5, mlab=mlabfun("RE Model for Subgroup", res.Levy2006PRAISE))
# addpoly(x =resS_disc_ACM_2yr_updatemod$est, ci.lb=resS_disc_ACM_2yr_updatemod$ci.lb, ci.ub=resS_disc_ACM_2yr_updatemod$ci.ub,
