...
# figfile <- "Fig7e_S_5yr_ACMapprox_disc_rob.jpg"
...
# resS_disc_ACM_5yr_all <- rma.res[[2]]
# res.all <- rma.res[[3]]
# 
...
rma.res <- fn_ma_cstat(dat)
resS_disc_ACM_5yr_hrob <- rma.res[[2]]
res.hrob <- rma.res[[3]]
...
rma.res <- fn_ma_cstat(dat)
resS_disc_ACM_5yr_lrob <- rma.res[[2]]
res.lrob <- rma.res[[3]]
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_5yr_urob <- rma.res[[2]]
# res.urob <- rma.res[[3]]
#
resS_disc_ACM_5yr_urob <- c(rep("-",5), 0, "-") 
...
#        rows=c(43:24,19:10,5:3), # CHANGE studies within groups
#        ylim=(c(-5,nrow(y)+14)),
#        main=titplot
# )
# 
...
# text(-0.3, c(44,20,6), pos=4, c("High RoB Participants",
...
# addpoly(x = resS_disc_ACM_5yr_all$est, ci.lb=resS_disc_ACM_5yr_all$ci.lb, ci.ub=resS_disc_ACM_5yr_all$ci.ub,
...
# addpoly(x = resS_disc_ACM_5yr_hrob$est, ci.lb=resS_disc_ACM_5yr_hrob$ci.lb, ci.ub=resS_disc_ACM_5yr_hrob$ci.ub,
#         row=22.5, mlab=mlabfun("RE Model for Subgroup", res.hrob))
# addpoly(x = resS_disc_ACM_5yr_lrob$est, ci.lb=resS_disc_ACM_5yr_lrob$ci.lb, ci.ub=resS_disc_ACM_5yr_lrob$ci.ub,
#         row= 8.5, mlab=mlabfun("RE Model for Subgroup", res.lrob))
# addpoly(x = resS_disc_ACM_5yr_urob$est, ci.lb=resS_disc_ACM_5yr_urob$ci.lb, ci.ub=resS_disc_ACM_5yr_urob$ci.ub,
