...
# figfile <- "Fig4e_S_2yr_ACMapprox_cal_rob.jpg"
...
rma.res <- fn_ma_oe(dat)
resS_cal_ACM_2yr_hrob <- rma.res[[2]]
res.hrob <- rma.res[[3]]
...
rma.res <- fn_ma_oe(dat)
resS_cal_ACM_2yr_lrob <- rma.res[[2]]
res.lrob <- rma.res[[3]]
...
# 
# rma.res <- fn_ma_oe(dat)
# resS_cal_ACM_2yr_urob <- rma.res[[2]]
# res.urob <- rma.res[[3]]

resS_cal_ACM_2yr_urob <- c(rep("-",5), 0, "-")
...
#                 rows=c(31:13,8:3), # CHANGE studies within groups
#                 ylim=(c(-5,nrow(y)+10)),
...
# text(-0.3, c(32,9), pos=4, c("High RoB Participants",
...
# addpoly(x = resS_cal_ACM_2yr_25$est, ci.lb=resS_cal_ACM_2yr_25$ci.lb, ci.ub=resS_cal_ACM_2yr_25$ci.ub,
...
# addpoly(x = resS_cal_ACM_2yr_hrob$est, ci.lb=resS_cal_ACM_2yr_hrob$ci.lb, ci.ub=resS_cal_ACM_2yr_hrob$ci.ub,
#         row=11.5, mlab=mlabfun("RE Model for Subgroup", res.hrob))
# addpoly(x = resS_cal_ACM_2yr_lrob$est, ci.lb=resS_cal_ACM_2yr_lrob$ci.lb, ci.ub=resS_cal_ACM_2yr_lrob$ci.ub,
#         row= 1.5, mlab=mlabfun("RE Model for Subgroup", res.lrob))
# # addpoly(x = resS_cal_ACM_2yr_urob$est, ci.lb=resS_cal_ACM_2yr_urob$ci.lb, ci.ub=resS_cal_ACM_2yr_urob$ci.ub,
