...
table(dat1$S1, useNA = "always") #7


dat2 <- dat[which(dat$S1=="Chronic"),] 

table(dat2$S1, useNA = "always") #7
...
rma.res <- fn_ma_cstat(dat)
resM_disc_ACM_1yr_acute <- rma.res[[2]]
res.acute <- rma.res[[3]]
...
rma.res <- fn_ma_cstat(dat)
resM_disc_ACM_1yr_chronic <- rma.res[[2]]
...
rma.res <- fn_ma_cstat(dat)
resM_disc_ACM_1yr_uncmixhf <- rma.res[[2]]
...
forest(y$theta, ci.lb=y$theta.ciub, ci.ub=y$theta.cilb,
       ...
       rows=c(33:27,22:16,11:3), # CHANGE studies within groups
       ylim=(c(-5,nrow(y)+14)),
       main=titplot
)
...
text(-0.3, c(34,23,12), pos=4, c("Acute Heart Failure",
...
addpoly(x = resM_disc_ACM_1yr_acute$est, ci.lb=resM_disc_ACM_1yr_acute$ci.lb, ci.ub=resM_disc_ACM_1yr_acute$ci.ub,
        row=25.5, mlab=mlabfun("RE Model for Subgroup", res.acute))
addpoly(x = resM_disc_ACM_1yr_chronic$est, ci.lb=resM_disc_ACM_1yr_chronic$ci.lb, ci.ub=resM_disc_ACM_1yr_chronic$ci.ub,
        row= 14.5, mlab=mlabfun("RE Model for Subgroup", res.chronic))
addpoly(x = resM_disc_ACM_1yr_uncmixhf$est, ci.lb=resM_disc_ACM_1yr_uncmixhf$ci.lb, ci.ub=resM_disc_ACM_1yr_uncmixhf$ci.ub,
