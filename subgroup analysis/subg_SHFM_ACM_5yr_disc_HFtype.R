...
# figfile <- "Fig7f_S_5yr_ACMapprox_disc_HFtype.jpg"
...
# 
# table(dat1$S1, useNA = "always") #6
# 

dat2 <- dat[which(dat$S1=="Chronic"),] 

table(dat2$S1, useNA = "always") #18


# dat3 <- dat[which(dat$S1=="Unclear/Mixed" | dat$S1==""),] 
# 
# table(dat3$S1, useNA = "always") #9
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_5yr_acute <- rma.res[[2]]
# res.acute <- rma.res[[3]]
#
resS_disc_ACM_5yr_acute <- c(rep("-",5), 1, "-") 
#
################################################################################################
###########     GROUP 2 #############
################################################################################################
...
rma.res <- fn_ma_cstat(dat)
resS_disc_ACM_5yr_chronic <- rma.res[[2]]
...
# 
# rma.res <- fn_ma_cstat(dat)
# resS_disc_ACM_5yr_uncmixhf <- rma.res[[2]]
# res.uncmixhf <- rma.res[[3]]
#
resS_disc_ACM_5yr_uncmixhf <- c(rep("-",5), 2, "-") 
#
...
# addpoly(x =resS_disc_ACM_5yr_acute$est, ci.lb=resS_disc_ACM_5yr_acute$ci.lb, ci.ub=resS_disc_ACM_5yr_acute$ci.ub,
#         row=36.5, mlab=mlabfun("RE Model for Subgroup", res.acute))
# addpoly(x =resS_disc_ACM_5yr_chronic$est, ci.lb=resS_disc_ACM_5yr_chronic$ci.lb, ci.ub=resS_disc_ACM_5yr_chronic$ci.ub,
#         row= 14.5, mlab=mlabfun("RE Model for Subgroup", res.chronic))
# addpoly(x =resS_disc_ACM_5yr_uncmixhf$est, ci.lb=resS_disc_ACM_5yr_uncmixhf$ci.lb, ci.ub=resS_disc_ACM_5yr_uncmixhf$ci.ub,
