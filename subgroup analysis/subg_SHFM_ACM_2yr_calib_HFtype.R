...
# figfile <- "Fig4f_S_2yr_ACMapprox_cal_HFtype.jpg"
...
# 
# rma.res <- fn_ma_oe(dat)
# resS_cal_ACM_2yr_acute <- rma.res[[2]]
# res.acute<- rma.res[[3]]
#
resS_cal_ACM_2yr_acute <- c(rep("-",5), 0, "-")
...
rma.res <- fn_ma_oe(dat)
resS_cal_ACM_2yr_chronic <- rma.res[[2]]
...
# 
# rma.res <- fn_ma_oe(dat)
# resS_cal_ACM_2yr_uncmixhf <- rma.res[[2]]
# res.uncmixhf <- rma.res[[3]]
# 
resS_cal_ACM_2yr_uncmixhf <- c(rep("-",5), 1, "-")
